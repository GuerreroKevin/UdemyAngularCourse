...
export class AutocompleteActoresComponent {
  ...
  actores: actorAutoCompleteDTO[] = [
    ...
    { id: 3, nombre: 'Robert De Niro', personaje: '', foto: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Robert_de_Niro-9578.jpg/500px-Robert_de_Niro-9578.jpg' }
]
